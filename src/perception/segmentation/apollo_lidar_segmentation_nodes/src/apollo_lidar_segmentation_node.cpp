...
using autoware::perception::segmentation::apollo_lidar_segmentation::ApolloLidarSegmentation;
...
: Node("apollo_lidar_segmentation", options),
...
m_detector_ptr{std::make_shared<apollo_lidar_segmentation::ApolloLidarSegmentation>(
    declare_parameter<int>("range", 70),
    declare_parameter<double>("score_threshold", 0.8),
    declare_parameter<bool>("use_intensity_feature", true),
    declare_parameter<bool>("use_constant_feature", false),
    declare_parameter<double>("z_offset", 0.0),
    declare_parameter<double>("min_height", -5.0),
    declare_parameter<double>("max_height", 5.0),
    declare_parameter<double>("objectness_thresh", 0.5),
    declare_parameter<int>("min_pts_num", 3),
    declare_parameter<double>("height_thresh", 0.5}))
{
}
...
RCLCPP_COMPONENTS_REGISTER_NODE(
  autoware::perception::segmentation::apollo_lidar_segmentation_nodes::ApolloLidarSegmentationNode)
