...
: Node("point_cloud_filter_transform_node", node_options),
  m_angle_filter{
    static_cast<float32_t>(declare_parameter<double>("start_angle")),
    static_cast<float32_t>(declare_parameter<double>("end_angle"))},
  m_distance_filter{
    static_cast<float32_t>(declare_parameter<double>("min_radius")),
    static_cast<float32_t>(declare_parameter<double>("max_radius"))},
  m_input_frame_id{declare_parameter<std::string>("input_frame_id")},
  m_output_frame_id{declare_parameter<std::string>("output_frame_id")},
  m_init_timeout{std::chrono::milliseconds{declare_parameter<int>("init_timeout_ms")}},
  m_timeout{std::chrono::milliseconds{declare_parameter<int>("timeout_ms")}},
  ...
  m_expected_num_publishers{
    static_cast<size_t>(declare_parameter<int>("expected_num_publishers"))},
...
{  /// Declare transform parameters with the namespace
  this->declare_parameter<double>("static_transformer.quaternion.x");
  this->declare_parameter<double>("static_transformer.quaternion.y");
  this->declare_parameter<double>("static_transformer.quaternion.z");
  this->declare_parameter<double>("static_transformer.quaternion.w");
  this->declare_parameter<double>("static_transformer.translation.x");
  this->declare_parameter<double>("static_transformer.translation.y");
  this->declare_parameter<double>("static_transformer.translation.z");
