...
TEST(ClassificaitonTrackerTest, TestMultipleUpdates) {
  const DetectedObject car = create_object(
    {{autoware_auto_perception_msgs::msg::ObjectClassification::CAR, 1.0F}});
  const DetectedObject truck = create_object(
    {{autoware_auto_perception_msgs::msg::ObjectClassification::TRUCK, 1.0F}});
...
TEST(ClassificaitonTrackerTest, TestMultipleUpdatesInOneObject) {
  ...
  {
    {autoware_auto_perception_msgs::msg::ObjectClassification::CAR, 0.6F},
    {autoware_auto_perception_msgs::msg::ObjectClassification::PEDESTRIAN, 0.4F}
  });
  const DetectedObject more_pedestrian = create_object(
  {
    {autoware_auto_perception_msgs::msg::ObjectClassification::CAR, 0.3F},
    {autoware_auto_perception_msgs::msg::ObjectClassification::PEDESTRIAN, 0.7F}
  });
  ClassificationTracker tracker;
...
TEST(ClassificaitonTrackerTest, TestUncartainObject) {
  const DetectedObject certain_car = create_object(
    {{autoware_auto_perception_msgs::msg::ObjectClassification::CAR, 0.9F}});
...
TEST(ClassificaitonTrackerTest, OverconfidentObject) {
  ...
  {
    {autoware_auto_perception_msgs::msg::ObjectClassification::CAR, 0.9F},
    {autoware_auto_perception_msgs::msg::ObjectClassification::PEDESTRIAN, 0.9F}
  });
  ClassificationTracker tracker;
