...
public:
  ...
  bool8_t success() const
  {
    ...
    RCLCPP_INFO(get_logger(), "\tShould receive: %u", (m_num_msgs * 2U));
    RCLCPP_INFO(get_logger(), "\tActual received: %u", m_num_received_msgs);
    ...
    RCLCPP_INFO(get_logger(), "\tShould have correct answer: %u", m_num_msgs);
    RCLCPP_INFO(
      get_logger(), "\tActual have correct answer: %u", m_num_correct_output);
