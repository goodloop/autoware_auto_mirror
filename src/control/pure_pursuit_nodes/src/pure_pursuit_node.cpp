    ...
    "tf", "trajectory", "ctrl_diag"}
{
  pure_pursuit::Config cfg{
    ...
    static_cast<float32_t>(
      declare_parameter<double>("controller.speed_to_lookahead_ratio")),
    declare_parameter<bool>("controller.is_interpolate_lookahead_point"),
    declare_parameter<bool>("controller.is_delay_compensation"),
    static_cast<float32_t>(declare_parameter<double>(
