...
def generate_launch_description():
    ...
    map_publisher_param_file = os.path.join(
        avp_demo_pkg_prefix, 'param/vw_golf/map_publisher_sim.param.yaml')
    ndt_localizer_param_file = os.path.join(
         avp_demo_pkg_prefix, 'param/vw_golf/ndt_localizer_sim.param.yaml')
    mpc_param_file = os.path.join(
         avp_demo_pkg_prefix, 'param/vw_golf/mpc_sim.param.yaml')
    pc_filter_transform_param_file = os.path.join(
        avp_demo_pkg_prefix, 'param/vw_golf/pc_filter_transform.param.yaml')
    vehicle_characteristics_param_file = os.path.join(
        avp_demo_pkg_prefix, 'param/vehicle_characteristics.param.yaml')

    urdf_pkg_prefix = get_package_share_directory('leo_golf_description')
    urdf_path = os.path.join(urdf_pkg_prefix, 'urdf/leo_golf.urdf')
