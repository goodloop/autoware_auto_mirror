...
def generate_launch_description():
    ...
    """
    # --------------------------------- Params -------------------------------
    joy_translator_param_file = get_share_file_path_from_package(
        package_name='test_trajectory_following',
        file_name='logitech_f310_velocity_cmd.param.yaml')
    rviz_cfg_path = get_share_file_path_from_package(
    ...
    lexus_rx_450h_urdf_path = get_share_file_path_from_package(
        package_name='lexus_rx_450h_description', file_name='lexus_rx_450h.urdf')
    ...
    recordreplay_planner_path = get_share_file_path_from_package(
    ...
    vehicle_motion_sim_node = Node(
        package='test_trajectory_following',
        node_executable='vehicle_motion_sim.py',
