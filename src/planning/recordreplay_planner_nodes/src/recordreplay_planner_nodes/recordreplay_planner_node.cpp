...
: Node{"recordreplay_planner", node_options}
{
  ...
  const auto heading_weight = declare_parameter<double>("heading_weight");
  const auto min_record_distance = declare_parameter<double>("min_record_distance");
  const auto skip_first_velocity = declare_parameter<bool>("skip_first_velocity");
  m_goal_distance_threshold_m = declare_parameter<double>("goal_distance_threshold_m");
  m_goal_angle_threshold_rad = declare_parameter<double>("goal_angle_threshold_rad");
  m_enable_loop = declare_parameter<bool>("loop_trajectory");
  m_max_loop_gap_m = declare_parameter<double>("loop_max_gap_m");
