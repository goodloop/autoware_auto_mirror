...
void GlobalVelocityPlannerNode::init()
{
  ...
  const global_velocity_planner::GlobalVelocityPlannerConfig planner_config{
    static_cast<float32_t>(
      declare_parameter<double>("global_velocity_planner.trajectory_resolution")),
    static_cast<float32_t>(
      declare_parameter<double>("global_velocity_planner.lateral_acceleration")),
    static_cast<float32_t>(
      declare_parameter<double>("global_velocity_planner.longitudinal_acceleration"))};
