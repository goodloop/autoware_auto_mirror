...
: wheel_radius(wheel_radius),
  ...
  tire_cornering_stiffness_front_N_per_deg(tire_cornering_stiffness_front_n_per_deg),
  tire_cornering_stiffness_rear_N_per_deg(tire_cornering_stiffness_rear_n_per_deg),
...
std::string VehicleConstants::str_pretty() const
{
  return std::string{
    ...
    "tire_cornering_stiffness_front_N_per_deg: " + std::to_string(
      tire_cornering_stiffness_front_N_per_deg) + "\n"
    "tire_cornering_stiffness_rear_N_per_deg: " + std::to_string(
      tire_cornering_stiffness_rear_N_per_deg) + "\n"
