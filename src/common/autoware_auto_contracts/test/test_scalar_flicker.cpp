...
TEST(ScalarFlicker, PeakIndex_indices_are_valid) {
...
TEST(ScalarFlicker, PeakIndex_is_valid_for_array) {
...
TEST(ScalarFlicker, rotate_left_and_set_back) {
...
TEST(ScalarFlicker, greatest_magnitude_peak) {
...
TEST(ScalarFlicker, ScalarFlicker) {
