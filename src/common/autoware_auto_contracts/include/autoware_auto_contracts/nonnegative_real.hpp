...
/// \file
/// \brief This file defines the autoware_auto_contracts non-negative real type.

#ifndef AUTOWARE_AUTO_CONTRACTS__NONNEGATIVE_REAL_HPP_
#define AUTOWARE_AUTO_CONTRACTS__NONNEGATIVE_REAL_HPP_
...
typedef NonnegativeReal<common::types::float32_t> NonnegativeRealf;
typedef NonnegativeReal<common::types::float64_t> NonnegativeReald;

}  // namespace contracts
}  // namespace common
}  // namespace autoware

#endif  // AUTOWARE_AUTO_CONTRACTS__NONNEGATIVE_REAL_HPP_
