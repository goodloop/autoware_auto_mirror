...
/// \file
/// \brief This file defines the autoware_auto_contracts acute radian type.

#ifndef AUTOWARE_AUTO_CONTRACTS__ACUTE_RADIAN_HPP_
#define AUTOWARE_AUTO_CONTRACTS__ACUTE_RADIAN_HPP_
...
typedef AcuteRadian<::autoware::common::types::float32_t> AcuteRadianf;
typedef AcuteRadian<::autoware::common::types::float64_t> AcuteRadiand;
...
{
  constexpr auto ratio = static_cast<T>(::autoware::common::types::PI) / static_cast<T>(180);
  return r * ratio;
}
...
template<typename T>
AcuteRadian<T>::operator T() const {return r_;}
...
template<typename T>
AcuteRadian<T>::AcuteRadian(T r)
: r_(r)
{
  DEFAULT_ENFORCE(contracts_lite::range_checks::in_range_closed_open(
      r_, static_cast<T>(0), static_cast<T>(::autoware::common::types::PI_2)));
}
...
#endif  // AUTOWARE_AUTO_CONTRACTS__ACUTE_RADIAN_HPP_
