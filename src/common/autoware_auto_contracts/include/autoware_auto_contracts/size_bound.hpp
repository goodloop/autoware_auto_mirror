...
/// \file
/// \brief This file defines the autoware_auto_contracts size bound
/// type.

#ifndef AUTOWARE_AUTO_CONTRACTS__SIZE_BOUND_HPP_
#define AUTOWARE_AUTO_CONTRACTS__SIZE_BOUND_HPP_
...
public:
   ...
   *
   * @post The class invariant validity condition holds (see invariant in SizeBound).
   */
  SizeBound(size_t r)
  : r_(r)
  {
    DEFAULT_ENFORCE(contracts_lite::range_checks::in_range_closed_closed(r_, static_cast<size_t>(0),
      BOUND));
  }
...
#endif  // AUTOWARE_AUTO_CONTRACTS__SIZE_BOUND_HPP_
