...
{
  ret.x = std::max(norm_2d(minus_2d(corners[1U], corners[0U])), std::numeric_limits<float32_t>::epsilon());
  ret.y = std::max(norm_2d(minus_2d(corners[2U], corners[1U])), std::numeric_limits<float32_t>::epsilon());
}
////////////////////////////////////////////////////////////////////////////////
