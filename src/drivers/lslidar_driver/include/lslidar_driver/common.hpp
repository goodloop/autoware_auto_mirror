...
#ifndef LSLIDAR_DRIVER__COMMON_HPP_
#define LSLIDAR_DRIVER__COMMON_HPP_
...
// These constants seem to be shared among lslidar drivers. If a model with different specs is
...
/// conversion from a degree (ls) to idx
...
/// \brief computes 2 byte representation of two bytes from out of order lslidar packet
...
#endif  // LSLIDAR_DRIVER__COMMON_HPP_
