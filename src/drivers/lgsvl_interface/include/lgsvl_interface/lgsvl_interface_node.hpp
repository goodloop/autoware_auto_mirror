...
public:
  ...
  rclcpp::Publisher<autoware_auto_msgs::msg::WipersReport>::SharedPtr m_wipers_report_pub{};

  rclcpp::Subscription<autoware_auto_msgs::msg::WipersReport>::SharedPtr m_wipers_report_sub
  {};
